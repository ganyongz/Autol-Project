            ...
            <el-col :span="8">
              <dv-border-box12>
                <div style="display: flex; align-items: center; height: 100%; padding: 10px; font-size: 20px; text-align: center">
                  <div id="main" style="width: 15rem; height: 240px; padding: 10px"></div>
                ...
                <div style="display: flex; align-items: center; height: 100%; font-size: 20px; text-align: center">
                  <div style="width: 30%; padding: 5px">
                    ...
                    <div style="display: flex; justify-content: space-around">
                      <div class="jiance">
                        <p class="circle1"></p>
                        <p style="font-size: 12px">正常</p>
                      </div>
                      <br />
                      <div class="jiance">
                        <p class="circle2"></p>
                        <p style="font-size: 12px">预警</p>
                      </div>
                      <br />
                      <div class="jiance">
                        <p class="circle3"></p>
                        <p style="font-size: 12px">报警</p>
                      </div>
                    </div>
                    <dv-active-ring-chart :config="conf" style="width: 200px; height: 200px" />
                    <!-- <p>油液报警部件数量</p> -->
                    <!-- <p>{{ nub_alarmOil }}</p> -->
                  </div>
...
const conf = reactive({
  ...
  legend: {
    show: true, // 是否显示图例
    position: "right", // 图例位置，可选 'top', 'bottom', 'left', 'right'
    data: ["正常", "预警", "报警"] // 图例数据，应与 series 中的 name 对应
  },
  color: ["green", "#ffcc66", "red"],
  // 是否展示原始数据/百分比数值
