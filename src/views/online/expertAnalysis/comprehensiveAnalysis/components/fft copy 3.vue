<template>
  <div>
    <div v-if="fftData.dataset.source" ref="chartRef" style="width: 100%; height: 400px"></div>
...
const getTrendChart = async () => {
  ...
  if (res.code == "200" && res.data?.frequencies) {
    ...
    fftData.value.dataset.source = finalArr;
    console.log(fftData.value.dataset.source);
